...
<div class="container-full">
    <!-- Content Header (Page header) -->
            ...
            <div class="box">
                ...
                <div class="row">
                    <div class="col">
              <form action="{{ route('valley.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <input type="hidden" name="old_image_frist_ba" value="{{ $valleys->ba_frist_image }}">
                <input type="hidden" name="old_image_sec_ba" value="{{ $valleys->ba_sec_image }}">
                <input type="hidden" name="old_image_thi_ba" value="{{ $valleys->ba_thi_image }}">
            ...
            <div class="row"> <!-- start 2nd row  -->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                         <textarea type="text" name="frist_descrip" class="form-control"  >{!! $valleys->frist_descrip !!}</textarea> </div>
                         @error('frist_descrip')
                         <span class="text-danger">{{ $message }}</span>
                         @enderror
                    </div>
            ...
            <div class="row"> <!-- start 2nd row  -->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <h5>Descraption <span class="text-danger">*</span></h5>
                        <div class="controls">
                         <textarea type="text" name="sec_descrip" class="form-control"  >{!! $valleys->sec_descrip !!}</textarea> </div>
        ...
        <div class="row"> <!-- start 2nd row  -->
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <h5>Descraption <span class="text-danger">*</span></h5>
                    <div class="controls">
                     <textarea type="text" name="thi_descrip" class="form-control"  >{!! $valleys->thi_descrip !!}</textarea> </div>
...
<script type="text/javascript">
    ...
    // ----------------2rd- ba---------------------
    function mainThamUrl1stba(input){
		if (input.files && input.files[0]) {
			var reader = new FileReader();
			reader.onload = function(e){
				$('#mainThmb1stba').attr('src',e.target.result).width(80).height(80);
			};
			reader.readAsDataURL(input.files[0]);
		}
	}
