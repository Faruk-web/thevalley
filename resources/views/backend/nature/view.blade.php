    ...
    <div class="col-lg-8">
        <div class="box mt-2">
            <div class="box-header with-border text-center bg-secondary">
              <h3 class="box-title ">Natural Feture List</h3>
          </div>
        <!-- /.box-header -->
  <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('nature.edit',$item->id )}}" class="btn btn-primary">edit</a>
                        </td>
                        <td>
                        <a href="{{route('nature.delete',$item->id)}}" class="btn btn-primary">Delete</a>
                        </td>
                   </tr>
                   @endforeach
               </tbody>
...
<div class="col-lg-4">
    <div class="box mt-2">
        <div class="box-header with-border">
          <h3 class="box-title">Add Nature</h3>
      </div>
      <!-- /.box-header -->
      <div class="box-body">
        <form method="POST" action="{{ route('natur.store')  }}" enctype="multipart/form-data">
            @csrf
          ...
          <h5>Short Descraption<span class="text-danger">*</span></h5>
              <textarea name="short_descrip" rows="3"  id="textarea" class="form-control"></textarea>
              @error('short_descrip')
              <span class="text-danger">{{ $message }}</span>
              @enderror
          </div>
