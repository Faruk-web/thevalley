			 ...
			 <div class="box">
				...
				<div class="box-body">
					<div class="table-responsive">
                        ...
                        <form method="post" action="{{ route('profit.day') }}">
                            @csrf
			  ...
			  <!-- /.box -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('profit.month') }}">
                                    @csrf
                ...
                <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" name="year_name" id="datepicker" />
			 ...
			 <div class="box">
				...
				<div class="box-body">
					<div class="table-responsive">
                        ...
                        <form method="post" action="{{ route('profit.year') }}" >
